...
const Checkout = (pros) => {
  ...
  const handleSubmit = async (e) => {
    ...
    e.preventDefault();
    const response = await pros.stripe.createToken().catch(error => console.log(error));
    ...
    <section className="section form">
      ...
      <form className="checkout-form">
        ...
        <div className="stripe-input">
          <label htmlFor="card-element">Credit or Debit Crat</label>
...
const StripeWrapper = () => {
  return (
    <StripeProvider
      apiKey="pk_test_vPIAodwvZOec2UzX7mFA5opw00CJwTYHTN"
    >
      <Elements>
        <CardForm></CardForm>
      </Elements>
